...
.video {
      ...
      box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Optional: Add a subtle box shadow for a lifted effect */
    }
  ...
  <body>
    ...
    <div style="padding-top:3rem;">
      ...
      <h2 class="text-center mb-5">Video Yayasan Assyafiiah</h2>
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="video">
          <iframe width="100%" height="315" src="https://www.youtube.com/embed/Bc6SPtXV2xU?rel=0&amp;controls=1&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          <p>Audsi Aksi Indosiar 2022</p>
        </div>
      </div>

      <div class="col-md-4">
        <div class="video">
          <iframe width="100%" height="315" src="https://www.youtube.com/embed/ILmuCmY6hAs?si=p37pU_A9JK_0D9jj?rel=0&amp;controls=1&amp;showinfo=0"frameborder="0" allowfullscreen></iframe>
          <p>Lauching Assyafiiah </p>
        </div>
      </div>

      <div class="col-md-4">
        <div class="video">
          <iframe width="100%" height="315" src="https://youtube.com/embed/3v4HHjO1sf4?si=URDIqe5d9YYI_sjl?rel=0&amp;controls=1&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
          <p>After movie wisuda dan Imtihan Genap 2023</p>
        </div>
      </div>

      <!-- Repeat the structure for the remaining videos -->
