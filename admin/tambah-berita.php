...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($tmp_file, $folder . $nama_file)) {
        ...
        mysqli_query($koneksi, "INSERT INTO berita(judul, alamat, tanggal, isi, foto) VALUES('$judul','$tempat','$tanggal','$isi','$nama_file')");
        echo "<script>alert('Berhasil Upload Foto'); window.location.href='berita.php';</script>";
    } else {
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="inputEmail" type="text" name="judul"/>
                                    <label for="inputEmail">Judul</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="inputEmail" type="text" name="tempat"/>
