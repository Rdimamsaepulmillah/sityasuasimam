...
<h2 class="text-center mb-5">Sarana Infrastruktur</h2>

<div class="row">
  <div class="col-md-3">
    <div class="facility">
      <img src="assets/img/masjid2.jpg" alt="Facility 1">
      <h2>Masjid AsSyafi'iah</h2>
      <p>Masjid Jami' Sekaligus Masjid TerTua yang ada Sedesa</p>
    </div>
  </div>

  <div class="col-md-3">
    <div class="facility">
      <img src="assets/img/halaman.jpg" alt="Facility 2">
      <h2>Kelas dan kantor</h2>
      <p>Didalam di bagi menjadi 3 kelas dan satu ruangan kantor</p>
    </div>
  </div>
  ...
  <!-- Repeat the structure for the remaining facilities -->
